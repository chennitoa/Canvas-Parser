MODULE_REQUIRED_PARAMETERS = {'name', 'unlock_at', 'position', 'require_sequential_progress', 'prerequisite_modules_ids', 'publish_final_grade', 'published'}
MODULE_ITEM_REQUIRED_PARAMETERS = {'title', 'type', 'content_id', 'position', 'indent', 'page_url', 'external_url', 'new_tab', 'completion_requirement', 'iframe'}
ASSIGNMENT_GROUP_REQUIRED_PARAMETERS = {'name', 'position', 'group_weight', 'sis_source_id', 'integration_data'}
ASSIGNMENT_REQUIRED_PARAMETERS = {'name', 'position', 'submission_types', 'allowed_extensions', 'turnitin_enabled', 'vericite_enabled', 'turnitin_settings',
...
DISCUSSION_TOPIC_REQUIRED_PARAMETERS = {'title', 'message', 'discussion_type', 'published', 'delayed_post_at', 'allow_rating', 'lock_at', 'podcast_enabled',
